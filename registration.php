                ...
                <div class="details ID">
                    ...
                    <div class="fields">
                        ...
                        <div class="input-field">
                            ...
                            <input type="number" name="backpaper" id="backpaper" value= "0" onload="intialcheck()" onblur="valdfn8()" onkeyup="valdfn8()"  placeholder="Enter no of back papers" required  >
                        </div>
                        <div class="input-field">
                            <label>GPA</label>
                ...
                <div class="details address">
                    ...
                    <div class="fields">
                        ...
                        <div class="input-field">
                            ...
                            <input type="number"  name="otherfee" id="otherfee"  onblur="valdfn14()" value="0" onload="initialcheck() onkeyup="valdfn14()"  placeholder="Enter other fee" required  >
                        </div>
                    </div>
                </div>
                ...
                <div class="details family">
                    ...
                    <div class="fields">
                        <div class="input-field">
                            ...
                            <input type="text" name="fname" id="fname"  onblur="valdfn15()" onkeyup="valdfn15()" value="null" onload="initialcheck()" placeholder="Enter father name" required >
                        </div>

                        <div class="input-field">
                            <label>Father age</label>
                            <input type="number" name="fage" id="fage" value= "0" onload="intialcheck()" onblur="valdfn16()" onkeyup="valdfn16()" placeholder="Enter father age" required  >
                        </div>

                        <div class="input-field">
                            <label>Father salary</label>
                            <input type="number" name="fsal" id="fsal" value= "0" onload="intialcheck()" onblur="valdfn17()" onkeyup="valdfn17()" placeholder="Enter father salary" required >
                        </div>

                        <div class="input-field">
                            <label>Mother Name</label>
                            <input type="text" name="mname" id="mname"  onblur="valdfn18()" value="null" onload="initialcheck()"  onkeyup="valdfn18()" placeholder="Enter mother name" required >
                        </div>

                        <div class="input-field">
                            <label>Mother age</label>
                            <input type="number" name="mage" id="mage" value= "0" onload="intialcheck()" onblur="valdfn19()" onkeyup="valdfn19()"placeholder="Enter mother age" required >
                        </div>

                        <div class="input-field">
                            <label>Mother salary</label>
                            <input type="number" name="msal" id="msal"  value= "0" onload="intialcheck()" onblur="valdfn20()" onkeyup="valdfn20()" placeholder="Enter mother salary" required >
                        </div>
                      
                        <div class="input-field">
                            <label>1st sibling Name</label>
                            <input type="text" name="s1name" id="s1name"  value="null" onload="initialcheck()" onblur="valdfn21()" onkeyup="valdfn21()" placeholder="Enter sibling1 name" required >
                        </div>

                        <div class="input-field">
                            <label>1st sibling age</label>
                            <input type="number" name="s1age" id="s1age" value= "0" onload="intialcheck()"  onblur="valdfn22()" onkeyup="valdfn22()"placeholder="Enter sibling1 age" required >
                        </div>

                        <div class="input-field">
                            <label>1st sibling salary</label>
                            <input type="number" name="s1sal" id="s1sal" value= "0" onload="intialcheck()"  onblur="valdfn23()" onkeyup="valdfn23()" placeholder="Enter sibling1 salary" required >
                        </div>
            
                        <div class="input-field">
                            <label>2nd sibling2 Name</label>
                            <input type="text" name="s2name" id="s2name" value="null" onload="initialcheck()" onblur="valdfn24()" onkeyup="valdfn24()" placeholder="Enter sibling2 name" required >
                        </div>

                        <div class="input-field">
                            <label>2nd sibling2 age</label>
                            <input type="number" name="s2age" id="s2age"  value= "0" onload="intialcheck()" onblur="valdfn25()" onkeyup="valdfn25()" placeholder="Enter sibling2 age" required >
                        </div>

                        <div class="input-field">
                            <label>2nd sibling salary</label>
                            <input type="number" name="s2sal" id="s2sal" value= "0" onload="intialcheck()" onblur="valdfn26()" onkeyup="valdfn26()" placeholder="Enter sibling2 salary" required >
                        </div>
                        <div class="input-field">
...
function initialcheck()
{
    ...
    /* document.getElementById("fathername").style.border = "2px solid green";
      document.getElementById("fatherage").style.border = "2px solid green";
     document.getElementById("fatherincome").style.border = "2px solid green";
      document.getElementById("mothername").style.border = "2px solid green";
       document.getElementById("motherage").style.border = "2px solid green";
        document.getElementById("motherincome").style.border = "2px solid green";
         document.getElementById("sibling1name").style.border = "2px solid green";
          document.getElementById("sibling2name").style.border = "2px solid green";
          document.getElementById("sibling2age").style.border = "2px solid green";
          document.getElementById("sibling2income").style.border = "2px solid green";
          document.getElementById("sibling1age").style.border = "2px solid green";
          document.getElementById("sibling1income").style.border = "2px solid green";
          document.getElementById("sibling2age").style.border = "2px solid green";*/
